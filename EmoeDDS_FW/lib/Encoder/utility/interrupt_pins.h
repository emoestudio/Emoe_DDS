...
// ESP32, ESP32-S2, ESP32-S3, ESP32-C3 (Arduino ESP32 Core)
#elif defined(ESP32)
  #define CORE_NUM_INTERRUPT GPIO_PIN_COUNT
  // GPIO 0-39 can generally be used as interrupts on standard ESP32
  #define CORE_INT0_PIN     0
  #define CORE_INT1_PIN     1
  #define CORE_INT2_PIN     2
  #define CORE_INT3_PIN     3
