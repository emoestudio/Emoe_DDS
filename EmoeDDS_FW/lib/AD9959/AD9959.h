...
#define PIN_RESET  46   // 复位引脚
#define PIN_UPDATE 15   // 更新引脚
#define PIN_CS     16   // 片选引脚
#define PIN_SCLK   17   // 时钟引脚
#define PIN_SDIO   18   // 数据IO引脚
#define PIN_SD1    8   // 数据1引脚
#define PIN_SD2    19  // 数据2引脚
#define PIN_SD3    20  // 数据3引脚
#define PIN_P0     4  // 配置档位0引脚
#define PIN_P1     5  // 配置档位1引脚
#define PIN_P2     6  // 配置档位2引脚
#define PIN_P3     7  // 配置档位3引脚
...
template <
        ...
        uint8_t         SPIClkPin = 17,         // Note: do not change the SPI pins, they're currently ignored.
        uint8_t         SPIMISOPin = -1,
        uint8_t         SPIMOSIPin = 18
>
class AD9959
{
...
public:
  ...
  AD9959()  : core_clock(0)  , last_channels(0xF0)
  {
    ...
    SPI.begin(PIN_SCLK, -1, PIN_SDIO, -1);
